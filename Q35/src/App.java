...
t1=new JTextField(); t1.setBounds(20,20,560,60); t1.setBackground(Color.BLACK); 
t1.setForeground(Color.CYAN); t1.setEditable(false); c.add(t1); setVisible(true); 
b1=new JButton("1"); b1.setBounds(20,110,70,30); c.add(b1); b1.setBackground(Color.GRAY); b1.setForeground(Color.WHITE);
b2=new JButton("2"); b2.setBounds(100,110,70,30); c.add(b2); b2.setBackground(Color.GRAY); b2.setForeground(Color.WHITE);
b3=new JButton("3"); b3.setBounds(180,110,70,30); c.add(b3); b3.setBackground(Color.GRAY); b3.setForeground(Color.WHITE);
b4=new JButton("4"); b4.setBounds(260,110,70,30); c.add(b4); b4.setBackground(Color.GRAY); b4.setForeground(Color.WHITE);
b5=new JButton("5"); b5.setBounds(20,150,70,30); c.add(b5); b5.setBackground(Color.GRAY); b5.setForeground(Color.WHITE);
b6=new JButton("6"); b6.setBounds(100,150,70,30); c.add(b6); b6.setBackground(Color.GRAY); b6.setForeground(Color.WHITE);
b7=new JButton("7"); b7.setBounds(180,150,70,30); c.add(b7); b7.setBackground(Color.GRAY); b7.setForeground(Color.WHITE);
b8=new JButton("8"); b8.setBounds(260,150,70,30); c.add(b8); b8.setBackground(Color.GRAY); b8.setForeground(Color.WHITE);
b9=new JButton("9"); b9.setBounds(20,190,70,30); c.add(b9); b9.setBackground(Color.GRAY); b9.setForeground(Color.WHITE);
b0=new JButton("0"); b0.setBounds(100,190,70,30); c.add(b0); b0.setBackground(Color.GRAY); b0.setForeground(Color.WHITE);
bd=new JButton("/"); bd.setBounds(500,150,70,30); c.add(bd); bd.setBackground(Color.BLACK); bd.setForeground(Color.WHITE);
ba=new JButton("+"); ba.setBounds(420,110,70,30); c.add(ba); ba.setBackground(Color.BLACK); ba.setForeground(Color.WHITE);
bs=new JButton("-"); bs.setBounds(500,110,70,30); c.add(bs); bs.setBackground(Color.BLACK); bs.setForeground(Color.WHITE);
bm=new JButton("x"); bm.setBounds(420,150,70,30); c.add(bm); bm.setBackground(Color.BLACK); bm.setForeground(Color.WHITE);
beq=new JButton("="); beq.setBounds(460,190,70,30); c.add(beq); beq.setBackground(Color.BLACK); beq.setForeground(Color.WHITE);
